...
assert.ok(!postmatch.includes("b.textContent='New Duel'"),'new-opponent action must not use the ambiguous New Duel label');
...
console.log('PASS Multiplayer Alpha 0.16.1 tester package + centered dramatic Arcade/Duel results + clear new-opponent action + Direct recovery + TURN + rematch + Pass & Play contracts');
