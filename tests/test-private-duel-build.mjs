...
for(const required of [
  'Multiplayer Alpha 0.16.4','<span>Multiplayer</span><small>Invite a player · Pass &amp; Play · Alpha test</small>','Play With Someone','Create Duel','Hosted Room',
  ...
  "const ALPHA_TESTER_VERSION='0.16.4'",'function alphaTesterInfo()','function alphaConnectionHelp()',
  "const EASY_LEARNING_STORAGE_KEY='clash4.easyLearning.v1'",'const EASY_LEARNING_PACING={combat:3600,combatChain:3200,special:2700,lock:1900,chain:900,aiBreath:900}',
  'One learning system: automatic explanations, plus optional Guided Tips for extra reminders.','Learn as you play','Guided Tips','GET 4 IN A ROW','1 · Pick a piece','2 · Tap a column',
  'function easyLearningPlaceCoach()','humanZone.insertBefore(coach,humanPanel)',"coach.dataset.placement='player'",'function easyLearningShowMe()','function easyLearningCombatLesson(e)','Rock–Paper–Scissors','function easyLearningSpecialLesson(e)',
  'const eventDurationBeforeEasyLearning=eventDuration','const startAiTurnBeforeEasyLearning=startAiTurn','EASY_LEARNING_PACING.aiBreath',
  '#easyLearningCoach.easyLearningCoach','.easyRpsCompass','.easyLearningPulse','.easyCombatLesson','.easy-learning-active #message{display:none!important}','.easyLearningCombinedSetup .guidedSetupControl{display:none!important}','#easyLearningCoach[data-placement="player"]',
...
console.log(`PASS generated Multiplayer Alpha 0.16.4 paced Easy-learning tester package (${ids.length} unique DOM ids, ${scripts.length} script blocks)`);
