...
for(const required of [
  'Multiplayer Alpha 0.16.8','<span>Multiplayer</span><small>Invite a player · Pass &amp; Play · Alpha test</small>','Play With Someone','Create Duel','Hosted Room',
  ...
  "const ALPHA_TESTER_VERSION='0.16.8'","const EASY_LEARNING_STORAGE_KEY='clash4.easyLearning.v1'","const GAMEPLAY_FLOW_VERSION='0.16.8'","const LEARNER_UX_VERSION='0.16.6'",
...
for(const obsolete of [
  'Multiplayer Alpha 0.16.4','Multiplayer Alpha 0.16.6</title>','Multiplayer Alpha 0.16.7</title>','DIRECT_PEER_TIMEOUT_MS=90_000','DIRECT_RETURN_KEY','directShowReturnLinkLanding','/api/direct/signals','id="duelDirectServerInput"',
...
console.log(`PASS generated Multiplayer Alpha 0.16.8 staged-capture clarity package (${ids.length} unique DOM ids, ${scripts.length} script blocks)`);