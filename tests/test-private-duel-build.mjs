...
for(const required of [
  'Multiplayer Alpha 0.16.6','<span>Multiplayer</span><small>Invite a player · Pass &amp; Play · Alpha test</small>','Play With Someone','Create Duel','Hosted Room',
  ...
  "const ALPHA_TESTER_VERSION='0.16.6'","const EASY_LEARNING_STORAGE_KEY='clash4.easyLearning.v1'","const GAMEPLAY_FLOW_VERSION='0.16.5'","const LEARNER_UX_VERSION='0.16.6'",
  '<span>Learn to Play</span><small>Easy · learning help on · start now</small>','function learnerQuickStart()',"beginRandomMatch('Learn to Play',{useDefaults:false})",'>Got it</button>',
  '.homeActions .homeLearn','.learning-awaiting-continue .overlay','.learnerContinueButton','function gameplayFlowBoardCenter()','--c4-board-center-x','#board.easyLearningBoardCue',
...
console.log(`PASS generated Multiplayer Alpha 0.16.6 one-tap learner tester package (${ids.length} unique DOM ids, ${scripts.length} script blocks)`);
