...
for(const required of [
  ...
  '.panel.ai .row>div:first-child','#aiColorLabel{display:inline-flex!important','function gameplayFlowBoardCenter()','--c4-board-center-x','#board.easyLearningBoardCue',
...
console.log(`PASS generated Multiplayer Alpha 0.16.6 skippable learner package (${ids.length} unique DOM ids, ${scripts.length} script blocks)`);
