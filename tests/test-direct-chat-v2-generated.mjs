...
])assert.ok(alpha.includes(token),`generated Alpha missing Universal Chat v2 token: ${token}`);
...
console.log('PASS generated Universal Direct Chat v2 package: cross-platform mobile layout + keyboard-safe composer + presentation isolation');
