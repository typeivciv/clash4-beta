...
html=html.replace(anchor,nearby+turn+colors+postmatch+tester+easy+flow+learner+theme_music+gameplay_v3+ui_consistency+screen_consistency+direct_chat+anchor,1)
OUT.write_text(html,encoding='utf-8')
TESTER_OUT.write_text(html,encoding='utf-8')
print(f'Built Multiplayer Alpha {VERSION} with Direct Duel P2P chat, five world themes, world-reactive events, Gameplay UI v3, consistency repairs, and procedural music into {OUT.name} and {TESTER_OUT.name}')
