...
# networks; 0.15.13 separates the 90-second guest connection-attempt timeout from a
# five-minute Player 1 invite lifetime so network switching does not consume the invite.
...
print(f'Built Duel Modes Alpha {VERSION} with 5-minute Direct invite + 90-second guest retry timeout + TURN + colors/share + unified Arcade/Direct post-match into {OUT.name}')