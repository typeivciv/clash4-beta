...
# networks; 0.15.9 unifies animated post-match results/rematch wording across Arcade and Direct Duel.
...
print(f'Built Duel Modes Alpha {VERSION} with one-scan Nearby + TURN + colors/share + unified Arcade/Direct post-match into {OUT.name}')
