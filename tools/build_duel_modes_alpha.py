...
# 0.16.8 keeps the learner UX and networking contracts intact while staging decisive
# Easy captures so the loser is readable before removal, and tightening the audited
# 292px desktop opponent card hierarchy.
...
print(f'Built Multiplayer Alpha {VERSION} with staged Easy captures and audited opponent HUD into {OUT.name} and {TESTER_OUT.name}')